	...
	<div class="page-container">
		...
		<div class="page-content">
			...
			<div class="page-content-wrap ">
				<div class="row  ">
					<form class="form-horizontal  " name='frm2' method="post" action="../../merchant/<?php echo $name; ?>/gateway_home.php?type=1" enctype="multipart/form-data" >
									...
									<div class="col-md-12">
										<div style="border:2px solid green; padding-top:10px; padding-left:25px; padding-bottom:10px;">
											<H2>Total Amount Payable <br><br>
												...
												<div id="amttot1" style='color:green; font-weight:bold;'><i class='fa fa-rupee'></i> &nbsp;0.00 /-</div>
											</h2>
