                                        ...
                                        <table class="table table-bordered table-striped">
											...
											<tr id="<?php echo $j; $j++; ?>">
												...
												<?php
													...
													{
														$val= "gdcollegeerp".($i)."_".(substr($i,2)+1);
                                                ...
                                                <tr id="<?php echo $j; ?>">
                                                    ...
                                                    <?php
														...
														if (strpos($d[6], "P") !== false) {
															$no = substr($d[6], 1);
															echo "<td style='font-size:25px;'><a href='get-fee-prop.php?recno=$no&sess=$d[7]&college_id=$_REQUEST[college_id]' target='_blank'><i class='fa fa-print'></i></a></td>";
														} else if (strpos($d[6], "R") !== false && !(strpos($d[4], "Extra Fees") !== false)) {
															$no = substr($d[6], 1);
															echo "<td style='font-size:25px;'><a href='get-fee-receipt.php?recno=$no&sess=$d[7]&college_id=$_REQUEST[college_id]' target='_blank'><i class='fa fa-print'></a></td>";
														} else {
															echo "<td></td>";
														}
 													?>
